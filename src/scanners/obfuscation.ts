...
const OBFUSCATION_PATTERNS: Array<{ pattern: RegExp; severity: "critical" | "high" | "medium"; description: string }> = [
  {
...
export function scanObfuscation(ctx: ScanContext): Finding[] {
